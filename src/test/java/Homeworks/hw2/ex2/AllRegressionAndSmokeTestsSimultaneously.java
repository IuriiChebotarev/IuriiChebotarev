...
public class AllRegressionAndSmokeTestsSimultaneously extends SeleniumBase {
    // TODO Why you decide create in this way?--REMADE
    // TODO How much drivers will be created here?--ONE DRIVER FOR EACH TREAD
    // TODO chromeDriver is not good name here--FIXED
    private static final ThreadLocal<WebDriver> drivers = new ThreadLocal<>();

    @BeforeMethod(alwaysRun = true)
    public void beforeMethod() {
        // TODO It will be better create instance of the Chrome here and add it to ThreadLocal--FIXED
